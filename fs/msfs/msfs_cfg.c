...
extern unsigned int AdvfsFragGroupDealloc;
 ...
 /* chvol scales by 16 to convert between 512-byte blocks and 8-kbyte buffers */
    ...
    size_t outdata_size)
{
	...
	case CFG_OP_RECONFIGURE:
		...
		/* Always do the callback on configuration. This ensures that
		 * items limited by memory size get adjusted if needed. */
